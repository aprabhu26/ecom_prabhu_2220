...
datagroup: ecom_prabhu_2220_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: ecom_prabhu_2220_default_datagroup
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "Ecom Prabhu 2220"
